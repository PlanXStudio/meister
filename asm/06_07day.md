...
**(참고)사전 설치용 python sdk 및 패키지**
- [다운로드](https://koreaoffice-my.sharepoint.com/:u:/g/personal/devcamp_korea_ac_kr/ERHYvE8rHMpKkXsNMODpP5IB32UFsoKuzkoIUry-oSQ5_Q?e=he1Jh9)   
  - 만약 C:/VSCode/ext/ 경로에 python 폴더가 있다면 삭제
  - C:/VSCode/ext/ 경로에 압축 해제
    - 사용자 환경 변수 중 PATH에 **C:/VSCode/ext/python** 및 **C:/VSCode/ext/python/Scripts** 경로 추가
    - 추가한 항목을 가장 앞으로 이동
