...
def main():
    ...
    with concurrent.futures.ProcessPoolExecutor(max_workers=8) as executor:
        childs.append(executor.submit(child_process, 1, 1_000_000+1, queue))
        for i in range(1, 7+1):
            childs.append(executor.submit(child_process, i*1_000_000, (i+1)*1_000_000+1, queue))
    ...
    while True:
        ...
        if isinstance(ret, int):
            total += ret
        elif isinstance(ret, str) and ret == 'QUIT':
            break
