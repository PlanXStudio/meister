...
**자동 설치**
PahoMqtt.py는 현재 pypi.org에 PySide6-PahoMqtt란 이름으로 등록되어 있으므로 pip로 간단하게 설치할 수 있습니다. 만약 paho-mqtt와 pyside6가 설치되어 있지 않다면, 의존성 문제를 해결하기 위해 이들도 함께 설치합니다.
```sh
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.grpLight_1.setAlignment(Qt.AlignLeading|Qt.AlignLeft|Qt.AlignVCenter)
        ...
        self.fndLight_1.setFrameShape(QFrame.Panel)
        self.fndLight_1.setFrameShadow(QFrame.Sunken)
        self.fndLight_1.setDigitCount(3)
        self.fndLight_1.setSegmentStyle(QLCDNumber.Outline)
        ...
        self.fndLight_2.setFrameShape(QFrame.Panel)
        self.fndLight_2.setFrameShadow(QFrame.Sunken)
        self.fndLight_2.setDigitCount(3)
        self.fndLight_2.setSegmentStyle(QLCDNumber.Outline)
        self.grpFan_1 = QGroupBox(self.centralwidget)
        self.grpFan_1.setObjectName(u"grpFan_1")
        self.grpFan_1.setEnabled(False)
        self.grpFan_1.setGeometry(QRect(20, 180, 261, 151))
        self.dialFan_1 = QDial(self.grpFan_1)
        self.dialFan_1.setObjectName(u"dialFan_1")
        self.dialFan_1.setGeometry(QRect(11, 18, 121, 121))
        ...
        self.dialFan_1.setNotchTarget(1.000000000000000)
        self.dialFan_1.setNotchesVisible(True)
        self.fndFan_1 = QLCDNumber(self.grpFan_1)
        self.fndFan_1.setObjectName(u"fndFan_1")
        self.fndFan_1.setGeometry(QRect(150, 46, 100, 60))
        self.fndFan_1.setFrameShape(QFrame.Panel)
        self.fndFan_1.setFrameShadow(QFrame.Sunken)
        self.fndFan_1.setDigitCount(3)
        self.fndFan_1.setSegmentStyle(QLCDNumber.Outline)
        self.grpFan_2 = QGroupBox(self.centralwidget)
        self.grpFan_2.setObjectName(u"grpFan_2")
        self.grpFan_2.setEnabled(False)
        self.grpFan_2.setGeometry(QRect(290, 180, 261, 151))
        self.dialFan_2 = QDial(self.grpFan_2)
        self.dialFan_2.setObjectName(u"dialFan_2")
        self.dialFan_2.setGeometry(QRect(11, 18, 121, 121))
        ...
        self.dialFan_2.setNotchTarget(1.000000000000000)
        self.dialFan_2.setNotchesVisible(True)
        self.fndFan_2 = QLCDNumber(self.grpFan_2)
        self.fndFan_2.setObjectName(u"fndFan_2")
        self.fndFan_2.setGeometry(QRect(150, 46, 100, 60))
        self.fndFan_2.setFrameShape(QFrame.Panel)
        self.fndFan_2.setFrameShadow(QFrame.Sunken)
        self.fndFan_2.setDigitCount(3)
        self.fndFan_2.setSegmentStyle(QLCDNumber.Outline)
        ...
        self.dialFan_2.valueChanged.connect(self.fndFan_2.display)
        self.dialFan_1.valueChanged.connect(self.fndFan_1.display)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.grpFan_1.setTitle(QCoreApplication.translate("MainWindow", u"Fan1", None))
        self.grpFan_2.setTitle(QCoreApplication.translate("MainWindow", u"Fan2", None))
    # retranslateUi
```
...
class CondCtrl(QMainWindow, Ui_MainWindow):
    ...
    def onFan1ValueChange(self, value):
        self.client.publish("asm/iot/pwm/fan/1", value)
    
    def onFan2ValueChange(self, value):
        self.client.publish("asm/iot/pwm/fan/2", value)
