...
"}")
        ...
        self.btLight1.setGeometry(QRect(90, 69, 391, 121))
        self.btLight1.setFont(font2)
...
"")
        ...
        self.tabTotalCtrl.setCurrentIndex(2)
...
### 코드 구현  
TotalCtrlUi.py를 활용하여 사용자 인터페이스에서 버튼을 누를 때마다 이를  MQTT 토픽 메시지로 발행하는 파이썬 코드를 작성합니다.
