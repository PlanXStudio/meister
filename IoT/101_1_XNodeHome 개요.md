...
**IoT 모트 확장 커넥터**  
![Ext Connector](res/xnode_ext_connector.png)
...
Auto 제어기의 터미널 블록은 기판에 고정한 후 클램핑 부품으로 나사를 사용하는 PCB 나사 식 터미널 블록으로 각 단자에 선을 끼운 후 고정할 때는 일자(-) 형 나사를 이용합니다.

![Terminal Block](res/term_block.png)
